...
class BedFeature(Feature):
    ...
    >>> b.name
    'hello'
    >>> b = BedFeature("chr10\t99\t122\tgoodbye".split("\t"))
    >>> b
...
class GTFFeature(GFFFeature):
    r"""
    >>> g = GTFFeature('11\tpseudogene\texon\t75780\t76143\t.\t+\t.\tgene_id "ENSG00000253826"; transcript_id "ENST00000519787"; exon_number "1"; gene_name "RP11-304M2.1"; transcript_name "RP11-304M2.1-201";'.split("\t"))
    >>> g
